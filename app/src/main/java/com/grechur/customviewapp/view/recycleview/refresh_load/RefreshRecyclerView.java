package com.grechur.customviewapp.view.recycleview.refresh_load;
...
import com.grechur.customviewapp.view.recycleview.WrapRecyclerView;
...
public class RefreshRecyclerView extends WrapRecyclerView{
    ...
    // 默认状态
    public int REFRESH_STATUS_NORMAL = 0x0011;//17
    // 下拉刷新状态
    public int REFRESH_STATUS_PULL_DOWN_REFRESH = 0x0022;//34
    // 松开刷新状态
    public int REFRESH_STATUS_LOOSEN_REFRESHING = 0x0033;//51
    // 正在刷新状态
...
//                    mCurrentRefreshStatus = REFRESH_STATUS_LOOSEN_REFRESHING;
    ...
    private void restoreRefreshView() {
        ...
        Log.e("TAG","mCurrentRefreshStatus-->"+mCurrentRefreshStatus+" "+REFRESH_STATUS_LOOSEN_REFRESHING);
        ...
        // 回弹到指定位置
        ValueAnimator animator = ObjectAnimator.ofFloat(currentTopMargin, finalTopMargin).setDuration(Math.abs(distance));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed) {
            if (mRefreshView != null && mRefreshViewHeight <= 0) {
                ...
                Log.e("TAG","mRefreshViewHeight ="+mRefreshViewHeight);
